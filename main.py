...
con_string="mongodb+srv://sundhar:KAARTECH@cluster.bi85tyv.mongodb.net/?retryWrites=true&w=majority"
...
def register_user():
    ...
    try:
        ...
        var2=req_body['password']
        if(var==""):
          msg="Enter username"
        elif(var2==""):  
          msg="Enter password"
        elif(not user_collection.find_one({"username":var})) and re.fullmatch(regex,req_body['username']):
          user_collection.insert_one(req_body) 
          msg='SignUp Successful'
        else:
          msg='Give valid credentials (mail)'
...
def signin():
    ...
    try:
        ...
        if(var==""):
          ...
          out=user_collection.find_one(data)
          u1=out.get('username')
          p1=out.get('password')
